...
export default function BusesPage() {
  return (
    <>
      <PageHeader eyebrow="Fleet" title="Buses" description="Keep every vehicle and its operating status in view." />
      <EntityManager<Bus>
        title="Buses"
        fields={[
        ...
        list={busService.list}
        create={busService.create}
        update={busService.update}
        deactivate={busService.deactivate}
